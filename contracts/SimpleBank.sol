...
contract SimpleBank {
    ...
    function deposit() public payable returns (uint) {
      ...
      require(enrolled[msg.sender] == true, "Only enrolled customers can make deposits");
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
      ...
      require (balances[msg.sender] >= withdrawAmount, "Insufficient funds to conduct transaction");
